...
const CreatePoint = () => {
  ...
  useEffect(() => {
    ...
    setInitialPosition([-16.7288353, -49.2475092]);
  ...
  async function handleSubmit(event: FormEvent) {
    ...
    message.toastSuccess('Ponto de coleta criado!!');
        ...
        <fieldset>
          ...
          <div className="field-group">
            ...
            <div className="field">
              ...
              <input type="text" name="watsapp" id="watsapp" onChange={handleInputChange} />
            </div>
          </div>
        </fieldset>
